...
export const setSettings = (settings: Settings): SettingsAction => ({ type: 'SET_SETTINGS', payload: settings })
export const setLoading = (loading: boolean): SettingsAction => ({ type: 'SET_LOADING', payload: loading })
export const setTimer = (timerRef: number): SettingsAction => ({ type: 'SET_TIMER', payload: timerRef })
export const applySettings = (isSettle: boolean): SettingsAction => ({ type: 'SETTLE', payload: isSettle })
